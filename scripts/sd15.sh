python -u -m accelerate.commands.launch --config_file node8.yaml --main_process_port 18905 \
training_script.py \
--pretrain_model runwayml/stable-diffusion-v1-5 --resolution 512 \
--train_batch_size 1 --gradient_accumulation_steps 1 --max_train_steps 2000 \
...
--seed 42 --K 5 --lora_rank 128 --training_prompts train_data_sd15/gan_gt_data.jsonl \
--total_step 30 --scheduler DDPM \
